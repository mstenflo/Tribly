  ...
  return (
    <form className='form' onSubmit={(e) => onSubmit(e)}>
      <div className='form-group'>
        ...
        />
        <small className='form-text'>Give your contribution a title</small>
      </div>
      <div className='form-group'>
        <textarea
      ...
      {loadingFile ? (
        <div>
          {file ? (
            <h1>File has been uploaded, you can submit your contribution</h1>
          ) : (
      ...
      <div className='form-group'>
        <div
          ...
          onClick={() => setFormData({ ...formData, filetype: 'image/*' })}
        >
          Image
        </div>
        <div
        ...
        <div
          className='btn btn-light'
          onClick={() => setFormData({ ...formData, filetype: 'audio/*' })}
        >
          Audio
        </div>
        <div
          className='btn btn-light'
          onClick={() => setFormData({ ...formData, filetype: 'youtube' })}
        >
          Youtube
        </div>
        <div
          className='btn btn-light'
          onClick={() => setFormData({ ...formData, filetype: 'link' })}
        >
          Link
        </div>
      </div>
      ...
      <div className='btn btn-light' onClick={() => cancel()}>
        Cancel
      </div>
